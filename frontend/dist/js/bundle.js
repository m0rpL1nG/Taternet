...
/***/ function(module, exports) {
	...
	angular.module('Main').factory('MainDataService', MainDataService);
	...
	function MainDataService($http, jwtHelper, localStorageService) {
	    ...
	    function getUsers() {
	        return $http.get('https://cdn.rawgit.com/Swimlane/angular-data-table/master/demos/data/100.json').then(getUsersComplete).catch(getUsersFailed);
	    ...
	    function Login(userObj) {
	        return $http.post('/api-token-auth/', userObj).then(loginComplete).catch(loginFailed);
...
/***/ function(module, exports) {
	...
	function MainController(MainDataService, $mdSidenav) {
	    ...
	    function login(userObj) {
	        ...
	        MainDataService.Login(userObj).then(function (response) {
...
/***/ function(module, exports) {
	...
	angular.module("Navigation").controller("NavController", NavController);
...
/***/ function(module, exports) {
	...
	angular.module('Users').factory('dataservice', dataservice);
	...
	function dataservice($http) {
	    ...
	    function getUsers() {
	        return $http({
	            ...
	            method: 'GET'
	        }).then(getUsersComplete).catch(getUsersFailed);
...
/***/ function(module, exports) {
	...
	function TransfersController(transferdataservice, $filter, filterFilter) {
	    ...
	    vm.stores = [{ name: "North Tampa", id: "01" }, { name: "Brandon", id: "02" }, { name: "South Tampa", id: "03" }, { name: "Lakeland", id: "04" }, { name: "Winter Haven", id: "05" }, { name: "Oldsmar", id: "06" }, { name: "Wesley Chapel", id: "07" }, { name: "Distribution", id: "09" }, { name: "Largo", id: "11" }, { name: "Port Richey", id: "12" }, { name: "Spring Hill", id: "13" }];
	    vm.stockClassifications = [{ name: "Floor Model", id: "01" }, { name: "Display", id: "02" }, { name: "Boxed", id: "03" }, { name: "Depot", id: "04" }, { name: "Return", id: "05" }, { name: "Lost", id: "06" }, { name: "Depot Overstock", id: "12" }];
	    ...
	    function getTransfers() {
	        ...
	        return transferdataservice.getTransfers().then(function (data) {
	    ...
	    function filterTransfers() {
	        ...
	        if (vm.inLocationFilter.store == "None") {
	            vm.inLocationFilter.store = null;
	        }
	        if (vm.toLocationFilter.store == "None") {
...
/***/ function(module, exports) {
	...
	function transferdataservice($http) {
	    ...
	    function getTransfers() {
	        ...
	        return $http.get("api/v1/transfers/").then(getTransfersComplete).catch(getTransfersFailed);
